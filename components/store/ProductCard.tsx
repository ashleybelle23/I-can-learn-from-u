...
export function ProductCard({ product, featured = false }: ProductCardProps) {
  if (featured) {
    return (
      <Link
        ...
        className="block rounded-2xl border border-[#231890]/20 bg-gradient-to-br from-[#fff8f0] to-[#fff0e8]/30 p-5 group hover:border-[#231890]/40 transition-all duration-200"
      >
        {/* Image placeholder */}
        <div className="w-full aspect-square rounded-xl bg-gradient-to-br from-[#fff0e8] to-[transparent] flex items-center justify-center mb-4 border border-[#ffffff]/30 overflow-hidden">
  ...
  return (
    <Link
      href={`/store/${product.slug}`}
      className="block rounded-2xl border border-[#ffffff]/80 bg-[#fff8f0]/40 p-4 group hover:bg-[#fff8f0] hover:border-[#ffffff] transition-all duration-200"
    >
      {/* Image placeholder */}
      <div className="w-full aspect-[4/3] rounded-xl bg-gradient-to-br from-[#fff0e8]/60 to-[transparent]/60 flex items-center justify-center mb-4 border border-[#ffffff]/20">
