    ...
    <div className="bg-[#07051a] min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        <section className="prose-brand space-y-4">
          <h2 className="text-2xl font-bold text-[#e8e4f8]">The origin</h2>
          <p>
        ...
        {/* What we believe */}
        <section>
          <h2 className="text-2xl font-bold text-[#e8e4f8] mb-6">What we believe</h2>
          <div className="space-y-4">
            {[
              ...
              <div
                key={item.belief}
                className="flex gap-5 p-6 rounded-2xl border border-[#3a2d78]/60 bg-[#130f30]/40"
              >
                <div className="text-[#c89040] text-xl mt-1 flex-shrink-0">{item.icon}</div>
                <div>
                  <h3 className="text-base font-semibold text-[#e8e4f8] mb-2">{item.belief}</h3>
                  <p className="text-sm text-[#2cd4f0] leading-relaxed">{item.description}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* Safety */}
        <section className="p-7 rounded-2xl border border-[#c89040]/25 bg-[#c89040]/06">
          <h2 className="text-xl font-bold text-[#d4a840] mb-4">On safety and limits</h2>
          <div className="space-y-3 text-sm text-[#a898d8] leading-relaxed">
            <p>
            ...
            <p>
              ...
              <strong className="text-[#d4a840]">911</strong> or the Suicide &amp; Crisis Lifeline at{" "}
              <strong className="text-[#d4a840]">988</strong>. No community platform replaces that.
            </p>
          </div>
        </section>
        ...
        {/* Contact / contribute */}
        <section id="contact">
          <h2 className="text-2xl font-bold text-[#e8e4f8] mb-6">Get involved</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              ...
              <div
                key={item.title}
                className="p-6 rounded-2xl border border-[#3a2d78]/60 bg-[#130f30]/40"
              >
                <h3 className="text-base font-semibold text-[#e8e4f8] mb-2">{item.title}</h3>
                <p className="text-sm text-[#2cd4f0] leading-relaxed mb-4">{item.description}</p>
                <Link
                  href={item.href}
                  className="inline-flex text-sm font-medium text-[#c89040] hover:text-[#a87828] transition-colors items-center gap-1"
                >
                  {item.cta}
