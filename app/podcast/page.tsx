      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        <div className="rounded-2xl border border-[#3c3070]/60 bg-[#181440]/40 p-8 md:p-12">
          <div className="max-w-2xl">
            ...
            <h2 className="text-2xl font-bold text-[#ede8f8] mb-4">
            ...
            <a
              href="/about#contact"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold bg-gradient-to-r from-[#d4a843] to-[#bf8030] text-[#09071c] hover:opacity-90 transition-opacity"
            >
              Reach out to us
            </a>
          </div>
