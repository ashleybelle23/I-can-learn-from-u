    ...
    <div className="bg-[#09071c] min-h-screen">
      ...
      <div className="border-b border-[#3c3070]/60 bg-[#181440]/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          />
          <div className="mt-6 p-4 rounded-xl border border-amber-600/30 bg-amber-900/20 max-w-2xl">
            <p className="text-sm text-amber-200/80 leading-relaxed">
              <strong className="text-amber-300">Important:</strong> This community provides peer support, not professional mental health care. If you or someone you know is in immediate danger, please call 911 or 988 (Suicide &amp; Crisis Lifeline).
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-2xl border border-[#3c3070]/60 bg-[#181440]/40 p-6">
              <p className="text-xs font-semibold tracking-[0.2em] uppercase text-[#d4a843] mb-1">
                Share your situation
              </p>
              <p className="text-sm text-[#9080c0] mb-5">
            ...
            <div className="rounded-2xl border border-[#3c3070]/40 bg-[#181440]/30 p-5">
              <p className="text-xs font-semibold text-[#c8b8f0] mb-3">Community values</p>
              ...
              <Link
                ...
                className="mt-4 block text-xs text-[#8aaa74] hover:text-[#c8b8f0] transition-colors"
              >
