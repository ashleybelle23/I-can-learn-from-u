  ...
  return (
    <div className="bg-[transparent]">
      ...
      <section className="relative overflow-hidden gradient-hero min-h-[90vh] flex items-center">
        ...
        <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-[#fff0e8]/30 blur-[100px] pointer-events-none" />
        <div className="absolute top-1/3 right-1/4 w-64 h-64 rounded-full bg-[#231890]/8 blur-[80px] pointer-events-none" />

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="max-w-3xl">
            <p className="text-xs font-semibold tracking-[0.25em] uppercase text-[#231890] mb-6">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/community"
                className="inline-flex items-center gap-2 px-7 py-4 rounded-xl text-base font-semibold bg-gradient-to-r from-[#231890] to-[#231890] text-[transparent] hover:opacity-90 transition-opacity"
              >
                Enter the community
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <Link
              key={pillar.title}
              href={pillar.href}
              className="group rounded-2xl border border-[#ffffff]/80 bg-[#fff8f0]/40 p-7 hover:bg-[#fff8f0] hover:border-[#ffffff] transition-all duration-200"
            >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        <div className="rounded-2xl border border-[#ffffff]/60 bg-[#fff8f0]/40 p-8 md:p-12">
          <div className="flex flex-col md:flex-row md:items-center gap-8 md:gap-12">
            <div className="flex-1">
              ...
              <Link
                href="/trust"
                className="inline-flex items-center gap-2 text-sm font-medium text-[#231890] hover:text-[#231890] transition-colors"
              >
